      ...
      <div class="artist-portal-container">
        <div class="artist-portal-header">
          <div style="display: flex; align-items: center; gap: 20px;">
            <img src="/static/assets/mascot_cat.svg" style="width: 70px; height: 70px; filter: drop-shadow(0 0 16px rgba(29, 185, 84, 0.4));" />
            <div>
              <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 4px;">
                <span style="background: rgba(139, 92, 246, 0.3); color: #c7d2fe; font-size: 0.75rem; font-weight: 800; padding: 4px 10px; border-radius: 500px; text-transform: uppercase; letter-spacing: 1px;">
                  EarRape Creator Studio
                </span>
              </div>
              <h1 class="artist-portal-title">EarRape for Artists</h1>
              <p class="artist-portal-sub">Publica sencillos, produce álbumes oficiales y analiza tus streams en tiempo real.</p>
            </div>
          </div>
